...
const Channel = () => {
    ...
    const { data: channelData } = useSWR<IChannel | any>(`/api/workspaces/${workspace}/channels/${channel}`, fetcher);
    ...
    return (
        <Container onDrop={onDrop} onDragOver={onDragOver}>
            ...
            <ChatList chatSections={chatSections} scrollbarRef={scrollbarRef} setSize={setSize} isReachingEnd={isReachingEnd} />
